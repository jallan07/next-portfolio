...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href="https://contra.com/joshallan"
        variant="primary"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Digital storyteller at work, amateur foodie at @rvagrubs, and girl
            dad at home.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Josh, a former digital marketer now working as a freelance
            software engineer in Richmond, VA. I help companies bridge the gap
            between user needs and product development.
          </p>
