    ...
    <Container className="mt-16 sm:mt-32">
      <header className="max-w-2xl">
        ...
        <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
          With 3 years of professional development experience following a
          10-year career in marketing, I'm equipped with a holistic
          understanding of user-driven development, enabling me to seamlessly
          translate user needs into efficient and innovative code. Learn more
          about my background and experience below.
        </p>
      </header>
